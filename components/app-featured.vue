      ...
      <div class="row col-6 justify-space-between">
        ...
        >
          ...
          <h3 class="description">
            Marcação de texto para ser preenchida depois da página ficar pronta,
            enquanto isso segue com o texto marcando a página.
          </h3>
        </div>
      </div>
      <div class="col-6">
        <div class="row">
          <div
            ...
            :class="card.color"
            class="card mini background"
          >
            <img
              class="logo-mini"
              src="@/assets/imgs/logo-placeholder-2-x.png"
              alt="Logo"
            />
          </div>
        </div>
